...
step2.on('text', async (ctx) => {
  try {
    ...
    if (number && number <= 6) {
      ...
      setStepPath(ctx, '0');
      await ctx.scene.enter('secondServiceSecondScene');
...
const secondServiceSecondSceneThirdScene = new WizardScene(
...
module.exports = { secondServiceSecondSceneThirdScene };
