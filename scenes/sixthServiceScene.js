...
step2.on('text', async (ctx) => {
  try {
    ...
    if (number && number <= 1) {
      ...
      return await ctx.scene.enter('sixthServiceSceneSecondScene');
...
const sixthServiceScene = new WizardScene(
  'sixthServiceScene',
  (ctx) => step1(ctx),
  step2,
  // step3
...
module.exports = { sixthServiceScene };
