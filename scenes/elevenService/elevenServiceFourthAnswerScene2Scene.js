...
comment.on('text', async (ctx) => { handleCommentScene(ctx, 'NARANJA X, PREX, YACARE'); });

const elevenServiceFourthAnswerScene2Scene = new WizardScene(
...
module.exports = { elevenServiceFourthAnswerScene2Scene };
